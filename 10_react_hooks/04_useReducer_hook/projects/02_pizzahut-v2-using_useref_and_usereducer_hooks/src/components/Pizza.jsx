function Pizza({pizza, deletePizzaFromList, addPizzaToCart, addPizzaToFavourites, userType}){
    ...
    <div className="">
      {
        ...
        <div className="">
          ...
          <button className="" onClick={() => addPizzaToFavourites(pizza.productID)}>Add to favourites</button>
        </div>
      }
      {
        userType === "seller" &&
